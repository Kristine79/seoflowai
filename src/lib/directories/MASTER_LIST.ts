...
export const MASTER_LIST: PlatformEntry[] = [
  ...
  { name: "Yellow Pages", url: "https://www.yellowpages.com", submissionUrl: "https://www.yellowpages.com/biz", type: "A", clientCategory: "Business Directory", method: "Stealth landing → Add business → manual captcha, fill, submit", notes: "List as ITllect under Digital Marketing Agency; upload logo; Cloudflare", priority: "HIGH" },
  ...
  { name: "FindUsHere", url: "https://www.find-us-here.com", submissionUrl: "https://www.find-us-here.com/register.php", type: "A", clientCategory: "Business Directory", method: "Register (no CAPTCHA, no email verify) → login → fill contact/address/description on dashboard", notes: "VERIFIED_SUCCESS: profile https://www.find-us-here.com/businesses/Itllect-LLC-Plantation-Florida-USA/34578398/; 18+ млн бизнесов", priority: "MEDIUM" },
  ...
  // ───── D — TECH / STARTUP ─────
  { name: "Crunchbase", url: "https://www.crunchbase.com", submissionUrl: "https://www.crunchbase.com/discover/principal.investors", type: "D", clientCategory: "Tech / Startup", method: "Register → add organization ITllect → verify via email-domain", notes: "account + claim verify", priority: "HIGH" },
  ...
  { name: "ProductHunt", url: "https://www.producthunt.com", submissionUrl: "https://www.producthunt.com/posts/new", type: "D", clientCategory: "Tech / Startup", method: "Register → launch ITllect product → launch flow", notes: "account + maker profile", priority: "MEDIUM" },
  ...
  // ───── D — SOCIAL ─────
  { name: "Twitter / X", url: "https://twitter.com", submissionUrl: "https://twitter.com/i/flow/signup", type: "D", clientCategory: "Social", method: "Register @ITllect handle → профиль компании → backlink в bio", notes: "account; phone verify", priority: "MEDIUM" },
  { name: "YouTube Channel", url: "https://www.youtube.com", submissionUrl: "https://www.youtube.com/create_channel", type: "D", clientCategory: "Social", method: "Create ITllect brand channel → link в about", notes: "Google account", priority: "MEDIUM" },
  ...
  { name: "GitHub", url: "https://github.com", submissionUrl: "https://github.com/organizations/new", type: "D", clientCategory: "Social", method: "Register → create Organization ITllect → profile+repo", notes: "account", priority: "MEDIUM" },
  { name: "Tumblr", url: "https://www.tumblr.com", submissionUrl: "https://www.tumblr.com/register", type: "D", clientCategory: "Social", method: "Register → create ITllect blog → first post", notes: "account", priority: "MEDIUM" },
  ...
  { name: "SlideShare", url: "https://www.slideshare.net", submissionUrl: "https://www.slideshare.net/signup", type: "D", clientCategory: "Social / Content", method: "Register (LinkedIn) → upload deck about ITllect", notes: "LinkedIn bridge", priority: "LOW" },
  { name: "Medium", url: "https://medium.com", submissionUrl: "https://medium.com/new-story", type: "D", clientCategory: "Content", method: "Register на info@itllect.com → email verify → draft pub about ITllect → publish", notes: "account + email verify", priority: "HIGH" },
  { name: "HubPages", url: "https://hubpages.com", submissionUrl: "https://hubpages.com/user/register", type: "D", clientCategory: "Content", method: "Register → publish Hub about ITllect", notes: "account", priority: "LOW" },
