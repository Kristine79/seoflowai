      ...
      <div className="flex">
        <div className="hidden w-44 shrink-0 border-r border-zinc-100 bg-white p-3 sm:block">
          <div className="flex items-center gap-2 px-2 pb-4 pt-1">
            ...
            <span className="text-xs font-semibold">SeoFlowAI</span>
          </div>
            ...
            <div key={row.label} className="flex items-center gap-3">
              ...
              <div className="h-1.5 flex-1 overflow-hidden rounded-full bg-zinc-100">
                <div
                  ...
                  style={{ width: `${Math.round((row.value / CASE_SUMMARY.total) * 100)}%` }}
                />
              </div>
              <span className="w-6 text-right text-xs font-medium text-zinc-700">{row.value}</span>
            </div>
          ))}
        </div>
      </ScreenCard>
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-zinc-200 bg-white">
      <div className="border-b border-zinc-100 px-4 py-3">
        <p className="text-sm font-medium">Каталоги</p>
        ...
        <div className="mt-4 space-y-3">
          {CASE_CATEGORIES.map((c) => (
            <div key={c.label} className="flex items-center gap-3">
              ...
              <span className="w-6 text-right text-xs font-medium text-zinc-700">{c.count}</span>
            </div>
          ))}
        </div>
      </ScreenCard>
      ...
      <ScreenCard>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold">Компания</p>
