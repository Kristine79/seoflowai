...
export const RESULT_TEXT: Record<string, string> = {
  ...
  "Bark.com": "VERIFIED_SUCCESS: аккаунт продавца создан 2026-08-10 13:39:13 — подтверждено через api.bark.com/seller/self. Dashboard live (15 leads, 3 services, 1 location). Регистрация серверная на шаге address-Next; профиль ITllect / Plantation FL. Повторная регистрация НЕ нужна.",
  ...
  "AngelList/Wellfound": "VERIFIED_SUCCESS: company profile создан и публично доступен — https://wellfound.com/company/itllect (slug itllect, location Coral Springs, Software, 1-10). Регистрация аккаунта itllect.marketing@gmail.com + профиль заполнены в headed-сессии 11.08; step 1 onboarding завершён, invite-шаг пропущен.",
